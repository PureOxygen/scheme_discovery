# ruby -r "./web_keyword_scraper.rb" -e 'WebKeywordScraper.new("https://www.qvc.com/Joan-Rivers-Set-of-3-Shimmering-Stone-Wire-Earrings.product.J358645.html?sc=NAVLIST").execute'
# ruby -r "./web_keyword_scraper.rb" -e 'WebKeywordScraper.new("https://www.atlutd.com/").execute'
